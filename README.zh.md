...
本地私有案例库共有 165 个已审计案例。完整语料前七批完成后，已有 142
个案例通过完整案例契约：包括原有 15 个 MVP 案例和新增恢复的 127 个案例。
...
互作 circos、分面 ANOVA 和进阶采样地图。最新带渲染审计记录为 142 个
完成、13 个有证据支持的阻塞、10 个待处理；阻塞细分为 6 个
...
- [ ] 将剩余 10 个私有案例逐个处理为 completed 或有充分证据的 blocked。
...
165 个私有案例中有 142 个满足完整契约，10 个仍为待处理，13 个具有通过
