...
本地私有案例库共有 165 个已审计案例。完整语料第一批完成后，已有 35
个案例通过完整案例契约：包括原有 15 个 MVP 案例和新增恢复的 20 个案例。
除原有分组散点、气泡、火山图、PCA、拟合趋势、ANOVA、扇形图、热图、
时序图、双向柱形图、进化树注释、网络图和无缝多面板外，现还覆盖多轨道
GO 富集圈图、五圈柱形扇形树、树与组成面板、表型注释热图、雷达小多图、
分组气泡矩阵、旭日图和基因组共线性圈图。带渲染审计记录为 35 个完成、
0 个阻塞、130 个待处理。由于尚未获得再分发许可，165 个案例均为
`private_only`。
...
- [ ] 将剩余 130 个私有案例逐个处理为 completed 或有充分证据的 blocked。
...
165 个私有案例中有 35 个满足完整契约，130 个仍为待处理，当前没有案例
