...
本地私有案例库共有 165 个已审计案例。完整语料前两批完成后，已有 55
个案例通过完整案例契约：包括原有 15 个 MVP 案例和新增恢复的 40 个案例。
...
自定义富集气泡图、分组热图及四种进化树布局。带渲染审计记录为 55 个完成、
0 个阻塞、110 个待处理。由于尚未获得再分发许可，165 个案例均为
`private_only`。
...
- [ ] 将剩余 110 个私有案例逐个处理为 completed 或有充分证据的 blocked。
...
165 个私有案例中有 55 个满足完整契约，110 个仍为待处理，当前没有案例
